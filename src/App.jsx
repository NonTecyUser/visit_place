...
function App() {
  ...
  <div className= "Journal">
   ...
   <Header></Header>
      ...
      {/* //entry 1 */}
      <Entry
       image={{src:"./src/assets/mountEverest.png",alt:"mount fuji"}}
    ...
    {/* //entry 2 */}
   <Entry
    image={{src:"./src/assets/mountFuji.png",alt:"mount fuji"}}
   ...
   {/* //entry 3 */}
   <Entry
    image={{src:"./src/assets/waterfall.png",alt:"Iguazu Waterfall"}}
   ...
   {/* //entry  4*/}
   <Entry
    image={{src:"./src/assets/desert.png",alt:"Grand Canyon"}}
